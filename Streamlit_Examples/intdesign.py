...
st.sidebar.write("This is an example of digiotai usecases")
...
if st.sidebar.button("Submit"):
    ...
    prompt = f"Generate a Realistic looking Interior design witht he following instructions style: {selected_style}, Room type: {selected_room}, Instructions: {additional_instructions}"

    # Generate image using the prompt
    image_url = sequential_flow.execute(prompt)
    
    # Display the generated image on the main page
    st.image(image_url, caption="Generated Interior Design")
